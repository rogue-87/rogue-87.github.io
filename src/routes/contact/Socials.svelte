<script lang="ts">
    ...
    $effect(() => {
        ...
        discord.addEventListener("click", () => {
            ...
            setTimeout(() => {
                title.textContent = "discord: rogue.sly";
            }, 2000);
        });
    });
</script>
...
<div class="socials-base">
    ...
    <a href="https://www.youtube.com/@rogue87dotsly" target="_blank" aria-label="youtube">
        <div class="social">
            <!-- flowbite--youtube -->
            <div class="social-inner">
                <svg
    ...
    <a href="https://bsky.app/profile/rogue-sly.bsky.social" target="_blank" aria-label="bluesky">
        <div class="social">
    ...
    <div class="social" id="discord">
        ...
        <span id="discord-title">discord: rogue.sly</span>
    </div>

    <a href="https://matrix.to/#/@rogue87:matrix.org" target="_blank" aria-label="matrix">
        <div class="social">
            <!-- tabler--brand-matrix -->
            <div class="social-inner">
                <svg
    ...
    <a href={`mailto:${email}`} target="_blank" aria-label={email}>
        <div class="social">
            <!-- tabler:mail-filled -->
            <div class="social-inner">
                <svg
